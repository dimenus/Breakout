...
pub const stbi_io_callbacks = extern struct {
    read: ?extern fn (?*c_void, [*c]u8, c_int) c_int,
    skip: ?extern fn (?*c_void, c_int) void,
    eof: ?extern fn (?*c_void) c_int,
};
...
pub const stbi_write_func = extern fn (?*c_void, ?*c_void, c_int) void;
...
pub const linux = 1;
pub const STBIWDEF = @"extern";
pub const STBIDEF = @"extern";
