...
pub const Instance = *@Type(.Opaque);
pub const PhysicalDevice = *@Type(.Opaque);
pub const Device = *@Type(.Opaque);
pub const Queue = *@Type(.Opaque);
pub const Semaphore = *@Type(.Opaque);
pub const CommandBuffer = *@Type(.Opaque);
pub const Fence = *@Type(.Opaque);
pub const DeviceMemory = *@Type(.Opaque);
pub const Buffer = *@Type(.Opaque);
pub const Image = *@Type(.Opaque);
pub const Event = *@Type(.Opaque);
pub const QueryPool = *@Type(.Opaque);
pub const BufferView = *@Type(.Opaque);
pub const ImageView = *@Type(.Opaque);
pub const ShaderModule = *@Type(.Opaque);
pub const PipelineCache = *@Type(.Opaque);
pub const PipelineLayout = *@Type(.Opaque);
pub const RenderPass = *@Type(.Opaque);
pub const Pipeline = *@Type(.Opaque);
pub const DescriptorSetLayout = *@Type(.Opaque);
pub const Sampler = *@Type(.Opaque);
pub const DescriptorPool = *@Type(.Opaque);
pub const DescriptorSet = *@Type(.Opaque);
pub const Framebuffer = *@Type(.Opaque);
pub const CommandPool = *@Type(.Opaque);
...
pub const SamplerYcbcrConversion = *@Type(.Opaque);
pub const DescriptorUpdateTemplate = *@Type(.Opaque);
...
pub const SurfaceKHR = *@Type(.Opaque);
...
pub const SwapchainKHR = *@Type(.Opaque);
...
pub const DisplayKHR = *@Type(.Opaque);
pub const DisplayModeKHR = *@Type(.Opaque);
...
pub const DebugReportCallbackEXT = *@Type(.Opaque);
...
pub const ObjectTableNVX = *@Type(.Opaque);
pub const IndirectCommandsLayoutNVX = *@Type(.Opaque);
...
pub const DebugUtilsMessengerEXT = *@Type(.Opaque);
...
pub const ValidationCacheEXT = *@Type(.Opaque);
...
pub const AccelerationStructureNV = *@Type(.Opaque);
...
pub const PerformanceConfigurationINTEL = *@Type(.Opaque);
